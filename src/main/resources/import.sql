...
insert into grupo (id, nome) values (2, 'Atendente');
...
insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'João Silva', 'teste@teste.com.br', '$2a$1', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (2, 'Maria Souza', 'teste2@teste.com.br', '$2a$2', utc_timestamp);
